...
@Component({
  selector: 'app-quimica-i',
  templateUrl: './quimica-i.component.html',
  styleUrls: ['./quimica-i.component.scss']
})
export class QuimicaIComponent implements OnInit, OnDestroy {
