...
@Component({
  selector: 'app-informatica-i',
  templateUrl: './informatica-i.component.html',
  styleUrls: ['./informatica-i.component.scss']
})
export class InformaticaIComponent implements OnInit, OnDestroy {
