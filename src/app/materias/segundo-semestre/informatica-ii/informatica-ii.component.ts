...
@Component({
  selector: 'app-informatica-ii',
  templateUrl: './informatica-ii.component.html',
  styleUrls: ['./informatica-ii.component.scss']
})
export class InformaticaIIComponent implements OnInit {
