...
@Component({
  selector: 'app-matematicas-ii',
  templateUrl: './matematicas-ii.component.html',
  styleUrls: ['./matematicas-ii.component.scss']
})
export class MatematicasIIComponent implements OnInit, OnDestroy {
